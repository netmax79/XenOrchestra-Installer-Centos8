...
curl -L -s -o /tmp/node-v8.17.0-linux-x64.tar.gz https://nodejs.org/dist/latest-v8.x/node-v8.17.0-linux-x64.tar.gz
tar -C /tmp -xzf /tmp/node-v8.17.0-linux-x64.tar.gz
CURD=`pwd`
cd /tmp/node-v8.17.0-linux-x64
